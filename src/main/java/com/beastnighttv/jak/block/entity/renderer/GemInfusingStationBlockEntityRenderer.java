package com.beastnighttv.jak.block.entity.renderer;
...
public class GemInfusingStationBlockEntityRenderer
        implements BlockEntityRenderer<GemInfusingStationBlockEntity> {
    public GemInfusingStationBlockEntityRenderer(BlockEntityRendererProvider.Context context) {}

    @Override
    public void render(GemInfusingStationBlockEntity pBlockEntity, float pPartialTick,
